 ...
 * @author alexg
 */
@WebServlet(name = "mermas", urlPatterns = {"/mermas"})
public class mermas extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (conexion.getStatusInsertar()==true){
            response.sendRedirect("ingresarExito.jsp");
        }else{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (opcion!=null){
                ...
                out.println("</tr>");
                out.println("</table>");
                out.println("<form action='http://localhost:8080/NanoInventario/mermas' method='GET'>");
               ...
               out.println("<meta charset='utf-8'/>");
                ...
                out.println("<br>");
                out.println("<form action='http://localhost:8080/NanoInventario/mermas' method='POST'>");
                out.println("<table class='table row justify-content-center' border='2'>");
                out.println("<tr>");
